...
import backgroundImage from "../../assets/images/Imagem cadastro.jpeg";
import "./Login.css";
        ...
        <Card className="text-center p-4">
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
              ...
              <InputGroup>
                ...
                <InputGroup.Text>
                  <a className="mostrarSenha mt-3 mx-1" onClick={mostrarSenha}>
                    <i
                      className={`bi bi-eye${mostrarSenhaV ? "-slash" : ""}`}
                    ></i>
                  </a>
                </InputGroup.Text>
              </InputGroup>
            ...
            <Card className="button-login">
              ...
              >
                <img src={googleIcon} width="30" alt="Google icon" /> Entrar com
                o Google
              </Button>
            </Card>
          </Form>
